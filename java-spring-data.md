...
We annotate this class with `@Component` to tell Spring Boot that we want this to be automatically added to the IoC container. It implements `CommandLineRunner` so that it will be run once at startup.
